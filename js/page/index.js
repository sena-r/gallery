...
function setModalPagerClickEvent(){
    const prevTop = document.getElementById("modal-prev-top");
    const nextTop = document.getElementById("modal-next-top");
    const prevBottom = document.getElementById("modal-prev-bottom");
    const nextBottom = document.getElementById("modal-next-bottom");
    clickPrev(prevTop);
    clickPrev(prevBottom);
    clickNext(nextTop);
    clickNext(nextBottom);
    function clickPrev(button){
